...
export async function GET() {
  const csv = `Company Name,Listing URL,Company Website,Industry,Location,Asking Price,Revenue,EBITDA,SDE / Cash Flow,Employees,Real Estate Included,FF&E,Seller Financing,Notes,Broker,Source
